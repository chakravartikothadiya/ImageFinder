...
public class ImageFinderTest {
  ...
  public void test() throws IOException, ServletException {
	    ...
	    Mockito.when(request.getParameter("url")).thenReturn("https://www.ubs.com/us/en.html"); //Sample URL for testing
	  	Mockito.when(request.getParameter("depth")).thenReturn("1"); // Provide a default depth value
